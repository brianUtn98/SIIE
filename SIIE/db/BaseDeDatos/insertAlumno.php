...
//consulta
$SQL="INSERT INTO alumno (Numero_de_documento,Apellido,Nombre,Sexo,Fecha_de_nacimiento,Lugar_de_nacimiento, 
Nacionalidad,Domicilio,Localidad,Codigo_postal, Telefono,Celular) VALUES
...
if(!$a=$con->query($SQL))
	...
	{
		//Redireccion 
		header('Location: ../Formularios/formAlumno.php');
	}
