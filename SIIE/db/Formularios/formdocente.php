...
<head>
	...
	<script language="JavaScript" src="../javascript/validaciondocente.js"> </script>
</head>
...
<body bgcolor=#c1c1c1>
	<header>
		<h2> 
			<div align=center> 
				<P style="COLOR: #FFFFFF; BACKGROUND-COLOR: #000000"> &nbsp; <br> Datos del docente <br> &nbsp;     </P>
			</div> 
		</h2>  
	</header>


	<form action="../basededatos/insertdocente.php" method='get'  name="formdocente" align=center>
		<BR>
		<table  cellspacing=7 cellpadding=7 align=center>
			<tr>  
				...
				<td> Num doc <BR> 
					<input type="text" name='dni' id='dni' onkeypress="return validacion_numeros()"> 
				</td> 
			</tr>
			<tr> 
				<td> Sexo <BR> 
			...
			<tr> 
				...
				<td> Localidad <br>  
					<select name='localidad' id='localidad' > <?php include "../BaseDeDatos/selectlocalidad.php"; ?> </select> 
				</td> 
				<td> Codigo postal <br> 
			...
			<tr> 
				...
				<td>  Correo <br> 
					<input type="text" name='correo' id='correo' onkeypress="return validacion_letras()"> 
				</td> 
			</tr>
		</table>
